...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12402 = (0);while(true){
var m_12403 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12403 == null))
{} else
{m_12403.call(null);
if((count_12402 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12404 = (count_12402 + (1));
count_12402 = G__12404;
continue;
}
} else
{}
