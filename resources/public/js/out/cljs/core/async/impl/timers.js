...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_12309 = (0);while(true){
if((i_12309 < arr.length))
{(arr[i_12309] = null);
{
...
{var i_12316 = (self__.level + (1));while(true){
if((i_12316 <= (new_level + (1))))
{(update[i_12316] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12318 = (0);while(true){
if((i_12318 <= self__.level))
{var links_12319 = (update[i_12318]).forward;if(((links_12319[i_12318]) === x__$1))
{(links_12319[i_12318] = (x__$1.forward[i_12318]));
{
var G__12320 = (i_12318 + (1));
i_12318 = G__12320;
continue;
}
} else
{{
var G__12321 = (i_12318 + (1));
i_12318 = G__12321;
continue;
}
}
