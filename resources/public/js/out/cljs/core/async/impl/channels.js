...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12408 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12408 = (function (val,box,meta12409){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12408.cljs$lang$type = true;
cljs.core.async.impl.channels.t12408.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12408";
cljs.core.async.impl.channels.t12408.cljs$lang$ctorPrWriter = (function (this__4162__auto__,writer__4163__auto__,opt__4164__auto__){return cljs.core._write.call(null,writer__4163__auto__,"cljs.core.async.impl.channels/t12408");
});
cljs.core.async.impl.channels.t12408.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12408.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12410){var self__ = this;
var _12410__$1 = this;return self__.meta12409;
});
cljs.core.async.impl.channels.t12408.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12410,meta12409__$1){var self__ = this;
var _12410__$1 = this;return (new cljs.core.async.impl.channels.t12408(self__.val,self__.box,meta12409__$1));
});
cljs.core.async.impl.channels.__GT_t12408 = (function __GT_t12408(val__$1,box__$1,meta12409){return (new cljs.core.async.impl.channels.t12408(val__$1,box__$1,meta12409));
});
}
return (new cljs.core.async.impl.channels.t12408(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_12411 = self__.takes.pop();if((taker_12411 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12411))
{var take_cb_12412 = cljs.core.async.impl.protocols.commit.call(null,taker_12411);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12412,taker_12411,this$__$1){
return (function (){return take_cb_12412.call(null,null);
});})(take_cb_12412,taker_12411,this$__$1))
);
} else
{}
{
