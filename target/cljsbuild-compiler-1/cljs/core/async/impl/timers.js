...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4162__auto__,writer__4163__auto__,opt__4164__auto__){return cljs.core._write(writer__4163__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_23692 = (0);while(true){
if((i_23692 < arr.length))
{(arr[i_23692] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4162__auto__,writer__4163__auto__,opt__4164__auto__){return cljs.core._write(writer__4163__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_23705 = (self__.level + (1));while(true){
if((i_23705 <= (new_level + (1))))
{(update[i_23705] = self__.header);
{
var G__23706 = (i_23705 + (1));
i_23705 = G__23706;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_23707 = (0);while(true){
if((i_23707 <= self__.level))
{var links_23708 = (update[i_23707]).forward;if(((links_23708[i_23707]) === x__$1))
{(links_23708[i_23707] = (x__$1.forward[i_23707]));
{
var G__23709 = (i_23707 + (1));
i_23707 = G__23709;
continue;
}
} else
{{
var G__23710 = (i_23707 + (1));
i_23707 = G__23710;
continue;
}
}
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3585__auto__,timeout__$1,me){
